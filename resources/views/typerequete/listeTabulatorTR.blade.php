...
@section('subcontent')
                @if($messageError==0)
                    <div class="alert alert-danger alert-dismissible show flex items-center mb-2" role="alert">
                        <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i> cette intervention existe déjà
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Liste des interventions</h2>
    ...
    <div class="intro-y box p-5 mt-5">
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="interventionListe" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body p-10 text-center">
                        <h2 class="text-lg font-medium mr-auto">Nouvelle Intervention</h2>
                </div>
                <div class="intro-y box">
                    <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                        <h2 class="font-medium text-base mr-auto">Intervention</h2>
                    </div>
                    <div id="vertical-form" class="p-5">
                        <div class="preview">
                            <form method="post" action="{{route('addTypeRequete')}}">
                                    @csrf
                                    @method('put')
                                <div class="mt-3">
                                    <label for="vertical-form-1" class="form-label">Intervention</label>
                                    <input type="text" id="vertical-form-1" class="form-control" name="Name" placeholder="{{ __('nom de l\'intervention') }}" value="" required />

                                </div>
                                <div class="mt-3">
                                    <label for="vertical-form-2" class="form-label">Description</label>
                                    <input type="text" id="vertical-form-2" class="form-control" name="Description" placeholder="{{ __('une petite description') }}" value="" required />
                                </div>
        ...
        $('#fabriquantId').change(function(){
            ...
            .then(modeleElement => {
              ...
              for(var i=0; i < modeleElement.length; i++) {
                 ...
                 $('#ModeleId').append('<option value=' + modeleElement[i].id + '>' + modeleElement[i].Name + '</option>');
