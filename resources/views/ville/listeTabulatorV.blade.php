...
@section('subcontent')
                ...
                @if($messageError==0)
                    <div class="alert alert-danger alert-dismissible show flex items-center mb-2" role="alert">
                        <i data-feather="alert-triangle" class="w-6 h-6 mr-2"></i> Echec d'enregistrement! la ville existe déjà en base..
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Liste des Villes</h2>
...
<!--             <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto" >
        ...
        <div class="overflow-x-auto scrollbar-hidden">
            <div id="listeVille" class="mt-5 table-report table-report--tabulator"></div>
        </div>
    </div>
    <!-- END: HTML Table Data -->
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body p-10 text-center">
                        <h2 class="text-lg font-medium mr-auto">Nouvelle Ville</h2>
                </div>
                <div class="intro-y box">
                    <div id="vertical-form" class="p-5">
                        <div class="preview">
                            <form method="post" action="{{ route('addVille') }}">
                            @csrf
                             @method('put')
                                <div class="mt-3">
                                    <label for="vertical-form-1" class="form-label">Nom</label>
                                    <input type="text" id="vertical-form-1" class="form-control" name="Name" placeholder="{{ __('nom de la ville') }}" value="" required />
                                </div>
                                <div class="mt-3">
                                    <label for="vertical-form-1" class="form-label">Description</label>
                                    <input type="text" id="vertical-form-1" class="form-control" name="Description" placeholder="{{ __('une petite description') }}" value="" required />                               
                                </div>
                                <div class="mt-3">     
