...
<!--                 <div class="col-span-12 lg:col-span-6 mt-8">
                ...
                <div class="col-span-12 sm:col-span-6 lg:col-span-3 mt-8">
                    <div class="intro-y flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Nombre d'opérations/Ville</h2>
                    ...
                    <div class="intro-y box p-5 mt-5">
                        ...
                        <div class="mt-8">
                            <div class="text-base text-gray-600 mt-1">Nombre d'opérations/ville</div>
                            <div id="legendChartPie">
                                <!-- <div class="flex items-center" >
                                    <div class="w-2 h-2 rounded-full mr-3" style="background-color: blue;"></div>
                                    <span class="truncate">Nombre d'opérations/ville</span>
